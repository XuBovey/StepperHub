...
stepper_error Stepper_SetupPeripherals(char stepperName, TIM_HandleTypeDef * stepTimer, uint32_t stepChannel, funPwmCtrl start, funPwmCtrl stop, GPIO_TypeDef  * dirGPIO, uint16_t dirPIN);
